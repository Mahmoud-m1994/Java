...
class GodkjenningBGS {
    ...
    private OppgaveOversikt1 oversikt;
    public GodkjenningBGS(OppgaveOversikt1 oversikt) {
    ...
    private void registrerNyStudent() {
        ...
        if (oversikt.RegNyttStud(navnNyStud)) {
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        OppgaveOversikt1 oversikt = new OppgaveOversikt1();
