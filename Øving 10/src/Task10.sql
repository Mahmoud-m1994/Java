...
CREATE TABLE byer_fylker(
  levby   VARCHAR(20) NOT NULL,
  fylke   VARCHAR(20) NOT NULL,
  CONSTRAINT byer_fylker_pk PRIMARY KEY (levby));
...
CREATE TABLE levinfo2(
  ...
  CONSTRAINT levinfo2_fk FOREIGN KEY(levby) REFERENCES byer_fylker(levby));
...
insert into levinfo(levnr, navn, adresse, levby, fylke, postnr) values(82,'Kontordata AS','åsveien 178','Trondheim','SørTrøndelag',7023);
...
insert into byer_fylker(levby, fylke) values('Oslo','Oslo');
insert into byer_fylker(levby, fylke) values('Trondheim','SørTrøndelag');
insert into byer_fylker(levby, fylke) values('ås','østfold');
insert into byer_fylker(levby, fylke) values('Oslo','Oslo');
insert into byer_fylker(levby, fylke) values('ås','østfold');
insert into byer_fylker(levby, fylke) values('ål','Telemark');

insert into levinfo2(levnr, navn, adresse, levby, postnr) values(6,'Kontorekspressen AS','Skolegata 3','Oslo','1234');
insert into levinfo2(levnr, navn, adresse, levby, postnr) values(82,'Kontordata','åsveien 178','Trondheim',7023);
insert into levinfo2(levnr, navn, adresse, levby, postnr) values(9,'Kontorutstyr AS','Villa Villekulla','ås',1456);
insert into levinfo2(levnr, navn, adresse, levby, postnr) values(44,'Billig og Bra AS','Aveny 56','Oslo',1222);
insert into levinfo2(levnr, navn, adresse, levby, postnr) values(12,'Mister Office AS','Storgt 56','ås',1456);
insert into levinfo2(levnr, navn, adresse, levby, postnr) values(81,'Kontorbutikken AS','Gjennomveien 78','ål',3345);
